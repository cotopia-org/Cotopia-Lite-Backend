...
Revision ID: 2b578a1f3b88
Revises: 
Create Date: 2024-06-02 18:00:15.774250
...
def upgrade() -> None:
    ...
    sa.Column('landing_spot', sa.String(length=100), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('room_id', sa.Integer(), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('voice_status', sa.Enum('disconnected', 'muted', 'unmuted', 'deafened', name='voicestatus'), nullable=True),
    sa.Column('video_status', sa.Enum('disconnected', 'camera', 'screen', name='videostatus'), nullable=True),
    sa.Column('coordinates', sa.String(length=100), nullable=True),
    sa.Column('screenshare_coordinates', sa.String(length=100), nullable=True),
    sa.Column('screenshare_size', sa.String(length=100), nullable=True),
    sa.Column('video_coordinates', sa.String(length=100), nullable=True),
    sa.Column('video_size', sa.String(length=100), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['room_id'], ['rooms.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
