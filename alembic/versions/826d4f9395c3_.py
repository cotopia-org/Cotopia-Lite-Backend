...
def upgrade() -> None:
    ...
    sa.Column('fillable_id', sa.Integer(), nullable=False),
    sa.Column('fillable_type', sa.String(length=31), nullable=False),
    sa.Column('mime_type', sa.String(length=31), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('ability', sa.String(length=63), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('video_coordinates', sa.String(length=31), nullable=False),
    sa.Column('video_size', sa.String(length=31), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['room_id'], ['rooms.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
